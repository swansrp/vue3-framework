...
export const bindRoleUserList = (entityId: string, attachIdList: Array<string>) => request(buildPostApi("/bind/batch"),{}, {entityId, attachIdList}, true, false) as Promise<any>
...
export const unbindRoleUserList = (entityId: string, attachIdList: Array<string>) => request(buildPostApi("/unbind/batch"),{}, {entityId, attachIdList}, true, false) as Promise<any>
