...
export const generalStatistic = (url: string, query: QueryType, sort: 0 | 1 | null, metricColumn: Array<{column: string, dictMap: any}>, metricCondition: Array<any>, statisticColumn: string, majorCondition='0', baseDomain?: string, showSuccess = true, showLoading = true) =>
...
export const advancedStatistic = (url: string, query: QueryType, sort: 0 | 1 | null, metricColumn: Array<{column: string, dictMap: any}>, metricCondition: Array<any>, statisticColumn: string,  majorCondition='0', baseDomain?: string, showSuccess = true, showLoading = true) =>
