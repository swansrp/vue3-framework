...
export const getPortalConfig = (name: string, roleId:any) => get(buildGetApi('/config'), {name, roleId}) as Promise<any>
...
export const existedPortalConfig = (name: string, roleId: any) => get(buildGetApi('/config/existed'), {name, roleId}, {}, false, false, false) as Promise<any>
