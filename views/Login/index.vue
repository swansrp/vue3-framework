  ...
  <div class="login-box fullscreen-bg">
    <div class="login-container">
      <div class="login-logo">
        <img :width="40" alt="登录图案" src="../../../assets/image/login/logo.png" class="logo-img" />
      ...
      <template v-else-if="registerMode">
        <div class="login-content-wrapper" style="margin-top: 60px">
          <msg-code
            ...
            <template #footer>
              <div style="display: flex;justify-content: flex-end; margin-top: -5px">
                <a-button 
                  ...
                  type="text" 
                  @click="changeToLoginMode">已有账号</a-button>
              </div>
            </template>
          </msg-code>
          <a-form v-else :model="registerForm" layout="horizontal" @finish="handleRegister">
            ...
            <a-form-item>
              <a-button :loading="loading" block html-type="submit" size="large" class="register-submit-btn" type="primary">
                注册并登录
              </a-button>
            </a-form-item>
          </a-form>
      ...
      <div v-else class="login-content-wrapper">
        ...
        <div class="login-footer-links">
          <a-button 
            class="login-mode-btn" 
            type="text" 
            @click="() => { registerMode = true; updateCaptchaUrl('REGISTER_CAPTCHA'); }">还没有账号</a-button>
        </div>
      </div>
    </div>
    <copyright-icp />
...
const afterLogin = (res: any) => {
  ...
  setTimeout(() => {
    if (successElement.parentNode) {
      successElement.style.animation = 'successSlideIn 0.4s cubic-bezier(0.4, 0, 0.2, 1) reverse'
      setTimeout(() => {
        if (successElement.parentNode) {
...
.fullscreen-bg {
  ...
  &::before {
    ...
    background: linear-gradient(135deg, 
      ...
      rgba(25, 45, 85, 0.10) 75%,
      rgba(5, 25, 55, 0.20) 100%);
  ...
  &::after {
    ...
    bottom: 0;
    background: 
      radial-gradient(circle at 30% 30%, rgba(100, 255, 218, 0.03) 0%, transparent 50%),
...
.login-box {
  ...
  :deep(.ant-input-password) {
    ...
    background: linear-gradient(145deg, 
      ...
      rgba(15, 30, 55, 0.90) 100%) !important;
  ...
  .login-footer-links {
    ...
    .login-mode-btn {
      ...
      &:hover {
        ...
        text-shadow: 
          0 1px 3px rgba(0, 0, 0, 0.9),
          0 0 8px rgba(255, 180, 120, 0.4) !important;
      }
