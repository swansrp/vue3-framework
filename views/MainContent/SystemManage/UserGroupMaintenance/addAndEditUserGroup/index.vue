<template>
  <a-form
    ref="formRef" :label-col="{ span: 6 }" :model="userGroupForm"
    :wrapper-col="{ span: 14 }" @finish="onAddAndEditFinish">
    <a-form-item :rules="[{ required: true, message: '请输入用户组名称!' }]" label="用户组名称" name="name">
